...
const getMockResponse = (options: MockResponseOptions): string => {
 ...
 */
export const getLLMCompletion = async (options: LLMCompletionOptions): Promise<string> => {
  const { prompt, modelPreference } = options;
